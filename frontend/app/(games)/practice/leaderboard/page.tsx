    ...
    <div className="relative overflow-hidden" style={{ height: '100vh' }}>
      ...
      >
        ...
        <h1 className="lb-rise-2 font-black leading-[1.02] mb-4"
          ...
          <span style={{ color: '#fff' }}>Rise to</span>
          <br />
          <span style={{
        ...
        <p className="lb-rise-3 text-base font-medium mb-9 max-w-sm mx-auto"
          ...
          Compete, climb, and dominate the word games leaderboard.
        </p>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      { label: 'Good   (50–75%)', color: '#6366f1', textColor: '#fff', pctMin: 0.5, pctMax: 0.75 },
                      { label: 'Mid    (25–50%)', color: '#a5b4fc', textColor: '#fff', pctMin: 0.25, pctMax: 0.5 },
                      { label: 'Rising (<25%)',   color: '#e5e7eb', textColor: '#6b7280', pctMin: 0, pctMax: 0.25 },
                    ].map((tier) => {
                  ...
                  <table className="w-full text-sm">
                    ...
                    >
                      <tr>
                        ...
                        <th className="text-right px-4 py-2.5 text-[9px] font-bold uppercase tracking-widest text-gray-400">Games</th>
                      </tr>
                    </thead>
                    <tbody>
                      {entries.map((entry, i) => {
