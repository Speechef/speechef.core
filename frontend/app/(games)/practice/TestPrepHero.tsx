...
interface Props {
  exams: readonly ExamConfig[];
}

const GRADIENT = 'linear-gradient(to right, #FADB43, #fe9940)';
const AUTO_MS  = 4000;

export default function TestPrepHero({ exams }: Props) {
  ...
  const goPrev = () => goTo((active - 1 + exams.length) % exams.length);
  const goNext = () => goTo((active + 1) % exams.length);
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes tp-progress-glow {
          0%, 100% { box-shadow: 0 0 6px rgba(250,219,67,0.4); }
          50%       { box-shadow: 0 0 16px rgba(254,153,64,0.7); }
        }

        .tp-stagger > *:nth-child(1) { animation: tp-card-in 0.42s cubic-bezier(0.2,0,0.2,1) 0.04s both; }
        .tp-stagger > *:nth-child(2) { animation: tp-card-in 0.42s cubic-bezier(0.2,0,0.2,1) 0.11s both; }
        .tp-stagger > *:nth-child(3) { animation: tp-card-in 0.42s cubic-bezier(0.2,0,0.2,1) 0.18s both; }
        .tp-stagger > *:nth-child(4) { animation: tp-card-in 0.42s cubic-bezier(0.2,0,0.2,1) 0.25s both; }

        .tp-shimmer-btn {
          background-size: 200% auto !important;
          animation: tp-shimmer 2.8s linear infinite;
        }
        .tp-shimmer-btn:hover { animation-duration: 1.2s; }
      `}</style>

      <div
        className="rounded-3xl overflow-hidden relative flex flex-col lg:h-[min(85vh,860px)]"
        style={{
          background: 'linear-gradient(160deg, #091828 0%, #0f1e4a 45%, #0d2a38 100%)',
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none select-none" aria-hidden>
          ...
          <div style={{
            ...
            background: 'linear-gradient(to right, transparent, rgba(14,165,233,0.14), transparent)',
          }} />
          <div style={{
            position: 'absolute', bottom: 0, left: 0, right: 0, height: '120px',
            background: 'linear-gradient(to top, rgba(9,24,40,0.5), transparent)',
          }} />
        </div>
        ...
        <div className="relative flex-1 flex flex-col lg:flex-row-reverse">
          ...
          <div className="lg:w-[380px] xl:w-[420px] flex-shrink-0 relative px-10 py-12 flex flex-col justify-center gap-9">
            ...
            <div
              ...
              style={{
                ...
                animation: 'tp-bar-glow 3.5s ease-in-out infinite',
              }}
            />
            ...
            <div>
              ...
              <span
                ...
                style={{
                  ...
                  animation: 'tp-fade-up 0.55s ease both',
              ...
              >
                Targeted mock tests and speaking tasks for every major English proficiency exam —
                track your score and close the gap fast.
              </p>
            </div>
            ...
            <div
              ...
              style={{ animation: 'tp-fade-up 0.55s ease both', animationDelay: '0.26s' }}
            >
              {[
                { value: `${exams.length - 1}+`, label: 'Exams'      },
                { value: 'Mock',                 label: 'Tests'       },
                { value: '🎯',                   label: 'Targeted'    },
              ].map((s, i, arr) => (
            ...
            {/* CTA */}
            <div style={{ animation: 'tp-fade-up 0.55s ease both', animationDelay: '0.33s' }}>
              <Link
                href="/practice/test-prep"
                className="tp-shimmer-btn inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full text-[14px] font-extrabold transition-all hover:scale-[1.04] active:scale-95"
                style={{
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2.5">
                {[
                  { label: 'Previous exam', icon: '‹', handler: goPrev },
                  { label: 'Next exam',     icon: '›', handler: goNext },
                ].map((btn) => (
                  <button
                    key={btn.label}
                    onClick={btn.handler}
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: '#ffffff',
                        border: `1.5px solid ${e.color.border}`,
                        boxShadow: isActive
                          ? `0 24px 70px rgba(0,0,0,0.28), 0 0 0 1px ${e.color.border}60, inset 0 1px 0 rgba(255,255,255,0.95)`
                          : 'none',
                      }}
                    >
                      {/* Card body */}
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between mb-5">
                            <span
                              ...
                              style={isActive
                                ? { display: 'inline-block', animation: 'tp-breathe 3.5s ease-in-out infinite 0.4s' }
                                : {}}
                            >
                              {e.emoji}
                            </span>
                              ...
                              {e.badge && (
                                <span
                                  ...
                                  style={{
                                    ...
                                    animation: 'tp-pop 0.4s cubic-bezier(0.2,0,0.2,1) 0.3s both',
                                  }}
                                >
                                  {e.badge}
                                </span>
                      ...
                      <div
                        ...
                        style={{
                          background: e.color.bg,
                          borderTop: `1px solid ${e.color.border}88`,
                        }}
                      >
                        <span
                          className="text-[12px] font-semibold"
                          style={{ color: e.color.text, opacity: 0.55 }}
                        >
                          Mock Tests ✦
                        </span>
                        <Link
            ...
            >
              {!paused && (
                <div
                  ...
                  style={{
                    background: GRADIENT,
                    animation: `tp-fill ${AUTO_MS}ms linear forwards`,
                    boxShadow: '0 0 10px rgba(250,219,67,0.5)',
                    animationName: 'tp-fill, tp-progress-glow',
