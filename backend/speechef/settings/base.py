...
# ── Email ────────────────────────────────────────────────────────────────────
# In development, emails print to the console.
# In production set EMAIL_BACKEND=django.core.mail.backends.smtp.EmailBackend
# and provide the SMTP credentials below.
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Speechef <noreply@speechef.com>')
